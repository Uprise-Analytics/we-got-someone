...
const SKILL_CATEGORIES = [
  ...
  { label: 'Blinds & Curtains',  icon: '🪟' },
  { label: 'Brick Layer',        icon: '🧱' },
  { label: 'Carpenter',          icon: '🪵' },
  { label: 'CCTV & Intercom',    icon: '📹' },
  { label: 'Ceiling',            icon: '🏛️' },
  { label: 'Cleaner',            icon: '🧹' },
  { label: 'Domestic Worker',    icon: '🏠' },
  { label: 'Drain Cleaning',     icon: '🪠' },
  { label: 'Electrician',        icon: '⚡' },
  { label: 'Flooring',           icon: '🟫' },
  { label: 'Gardener',           icon: '🌿' },
  { label: 'Handyman',           icon: '🔨' },
  { label: 'IT Specialist',      icon: '💻' },
  { label: 'Kitchen Installer',  icon: '🍳' },
  { label: 'Landscaping',        icon: '🌳' },
  { label: 'Mechanic',           icon: '🛠️' },
  ...
  { label: 'Rubble Removal',     icon: '🚜' },
  { label: 'Security',           icon: '🔒' },
  { label: 'Solar Installation', icon: '☀️' },
  { label: 'Tiler',              icon: '🔲' },
  { label: 'Tree Felling',       icon: '🪓' },
